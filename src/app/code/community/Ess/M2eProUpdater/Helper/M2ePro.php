...
class Ess_M2eProUpdater_Helper_M2ePro extends Mage_Core_Helper_Abstract
{
    const IDENTIFIER = 'Ess_M2ePro';

    const RELEASES_INFO_CACHE_KEY       = '_m2epro_releases_info_cache_';
    const LATEST_RELEASE_INFO_CACHE_KEY = '_m2epro_latest_release_info_cache_';
    ...
    public function isInstalled()
    {
        ...
        return in_array(self::IDENTIFIER, $modules);
    }
    ...
    public function getCurrentVersion()
    {
        ...
        /** @var Ess_M2ePro_Helper_Module $helper */
        $helper = Mage::helper('M2ePro/Module');
    ...
    public function getPackageVisibility()
    {
        ...
        return $config->isM2eProMinimumStabilityBetaTesters() ? Ess_M2eProUpdater_Model_Downloader::VISIBILITY_BETA
    ...
    public function getCodeDirectoryPaths()
    {
        $paths = array(
