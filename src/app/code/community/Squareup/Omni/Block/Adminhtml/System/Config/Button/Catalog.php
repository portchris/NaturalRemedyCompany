 ...
 * @author      SquareUp
 */
class Squareup_Omni_Block_Adminhtml_System_Config_Button_Catalog extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {
        return $this->getUrl('adminhtml/square/catalog');
    }
