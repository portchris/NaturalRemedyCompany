...
class InventoryChange implements ArrayAccess
{
    ...
    /**
     * Sets physical_count
     * @param \SquareConnect\Model\InventoryPhysicalCount $physical_count A physical count. Present if and only if `type` is `PHYSICAL_COUNT`.
     * @return $this
     */
    ...
    /**
     * Sets adjustment
     * @param \SquareConnect\Model\InventoryAdjustment $adjustment An adjustment. Present if and only if `type` is `ADJUSTMENT`.
     * @return $this
     */
