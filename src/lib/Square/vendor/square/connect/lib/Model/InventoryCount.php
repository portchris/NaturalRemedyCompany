...
class InventoryCount implements ArrayAccess
{
    ...
    protected $quantity;
    /**
      * $calculated_at Read-only time of the most recent physical count or adjustment that had an affect on the given product/status/location/quantity tuple.
      * @var string
      */
    ...
    /**
     * Sets calculated_at
     * @param string $calculated_at Read-only time of the most recent physical count or adjustment that had an affect on the given product/status/location/quantity tuple.
     * @return $this
     */
