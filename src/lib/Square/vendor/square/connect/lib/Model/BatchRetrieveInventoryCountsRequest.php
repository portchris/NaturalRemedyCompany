...
class BatchRetrieveInventoryCountsRequest implements ArrayAccess
{
    ...
    /**
      * $updated_after An RFC 3339 timestamp. Only counts whose `calculated_at` timestamp is later than the given time will be returned.
      * @var string
      */
    ...
    /**
     * Sets updated_after
     * @param string $updated_after An RFC 3339 timestamp. Only counts whose `calculated_at` timestamp is later than the given time will be returned.
     * @return $this
     */
