...
class InventoryPhysicalCount implements ArrayAccess
{
    ...
    protected $id;
    /**
      * $reference_id An optional id to tie this [InventoryPhysicalCount](#type-inventoryphysicalcount) to an external system.
      * @var string
      */
    ...
    /**
      * $quantity The quantity of the object as a decimal string. Fractional quantities are not currently supported. The database will truncate fractional values smaller than 1/100,000 when fractional values are supported.
      * @var string
      */
    protected $quantity;
    /**
    ...
    /**
      * $occurred_at The time associated with the physical count, in RFC 3339 format. On writes, cannot be older than 24 hours or in the future.
      * @var string
      */
    ...
    /**
     * Sets id
     * @param string $id The unique ID generated by Square's servers for this [InventoryPhysicalCount](#type-inventoryphysicalcount).
     * @return $this
     */
    ...
    /**
     * Sets reference_id
     * @param string $reference_id An optional id to tie this [InventoryPhysicalCount](#type-inventoryphysicalcount) to an external system.
     * @return $this
     */
    ...
    /**
     * Sets quantity
     * @param string $quantity The quantity of the object as a decimal string. Fractional quantities are not currently supported. The database will truncate fractional values smaller than 1/100,000 when fractional values are supported.
     * @return $this
     */
    ...
    /**
     * Sets occurred_at
     * @param string $occurred_at The time associated with the physical count, in RFC 3339 format. On writes, cannot be older than 24 hours or in the future.
     * @return $this
     */
    ...
    /**
     * Sets created_at
     * @param string $created_at Read-only time when the server received this physical count information, in RFC 3339 format.
     * @return $this
     */
