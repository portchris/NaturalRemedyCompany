...
class BatchChangeInventoryRequest implements ArrayAccess
{
    ...
    /**
      * $changes A set of new physical counts and adjustments to inventory to be added to the database. The changes are inserted based on the client supplied timestamp and can be inserted in the past and/or sent out of order. It may contain up to 100 changes.
      * @var \SquareConnect\Model\InventoryChange[]
      */
    protected $changes;
    /**
      * $ignore_unchanged_counts If `true`, when a physical count for an item variation has the same quantity as the most recent physical count for that variation, and there are no intervening adjustments for that variation, the incoming physical count is ignored.
      * @var bool
      */
    ...
    /**
     * Sets changes
     * @param \SquareConnect\Model\InventoryChange[] $changes A set of new physical counts and adjustments to inventory to be added to the database. The changes are inserted based on the client supplied timestamp and can be inserted in the past and/or sent out of order. It may contain up to 100 changes.
     * @return $this
     */
     ...
     * @param bool $ignore_unchanged_counts If `true`, when a physical count for an item variation has the same quantity as the most recent physical count for that variation, and there are no intervening adjustments for that variation, the incoming physical count is ignored.
     * @return $this
     */
