...
class InventoryApi
{
     ...
     * RetrieveInventoryAdjustment
     *
     * @param string $adjustment_id The unique id of the [InventoryAdjustment](#type-inventoryadjustment) to retrieve. (required)
     ...
     * RetrieveInventoryPhysicalCount
     *
     * @param string $physical_count_id The unique id of the [InventoryPhysicalCount](#type-inventoryphysicalcount) to retrieve. (required)
